...
abstract class $AddressResultCopyWith<T, $Res> {
  factory $AddressResultCopyWith(
      ...
      _$AddressResultCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$AddressResultCopyWithImpl<T, $Res>
    implements $AddressResultCopyWith<T, $Res> {
  _$AddressResultCopyWithImpl(this._value, this._then);

  final AddressResult<T> _value;
  // ignore: unused_field
  final $Res Function(AddressResult<T>) _then;
}
...
class __$$successCopyWithImpl<T, $Res>
    extends _$AddressResultCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'AddressResult<$T>.error(message: $message)';
  }
