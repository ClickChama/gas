...
class _loginPageState extends State<loginPage> {
  ...
  Future<bool> login() async {
    ...
    var url = Uri.parse(
        'https://click-chama-api.simetriastudio.dev.br/api/auth/customer/login');
    ...
    if (resposta.statusCode == 200) {
      await sharedPreferences.setString(
          'token', 'Bearer ${jsonDecode(responseBody)['access_token']}');
      await sharedPreferences.setString('user', '${jsonDecode(responseBody)}');
      return true;
    } else {
